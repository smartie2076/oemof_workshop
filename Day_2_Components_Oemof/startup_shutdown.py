...
"""
Example taken from git: /oemof/oemof_examples/oemof.solph/v0.3.x/start_and_shutdown_costs/data.csv
Requires data file: startup_shutdown.py
"""
"""
General description
-------------------
